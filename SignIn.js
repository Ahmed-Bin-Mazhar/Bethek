  ...
  return (
    <ScrollView>
      <View style={styles.Container}>
        ...
        <View >
          <View>
            <Feather name="user" size={20} color="black" paddingTop="30" alignContent="center" alignItems="center"
          ...
          {usernameshow === true ?
            <Text style={{ height: 30, color: "red" }} > Please Enter the UserName</Text> :
        ...
        <View >
          <View>
            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
              ...
              <TouchableOpacity onPress={() => { setPassShow(!PassShow); }} style={{ right: 15 }} >
                <MaterialCommunityIcons name={PassShow === false ? "eye" : "eye-off"} size={20} color="black" />
              </TouchableOpacity>
            </View>
            <TextInput
              placeholderTextColor="black"
          ...
          {passwordshow === true ?
            <Text style={{ height: 30, color: "red" }} > Please Enter the Password </Text> :
            <View style={{ padding: 15 }} />}
        </View>
      ...
      <View>
        ...
        >
          For New Users and Owners</Text>
      </View>

      {/* 2nd last button */}
      <View style={{
        paddingTop: 20, alignContent: "center", alignItems: "center",
        justifyContent: "center",
      }}>
        <TouchableOpacity
